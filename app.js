(function(){
  try {
    ...
    gsap.from('.hero-actions', { y: 20, opacity: 0, duration: 0.7, delay: 0.2, ease: 'power3.out' });
    gsap.from('.media-frame', { y: 30, opacity: 0, duration: 0.9, delay: 0.3, ease: 'power3.out' });
